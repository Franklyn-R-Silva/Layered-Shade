/**
 * Declarative configuration for the shadow/shape controls.
 */
export type ControlType = 'range' | 'color' | 'checkbox';
export type ControlCategory = 'shadow' | 'shape';
...
export const shadowControls: ControlConfig[] = [
